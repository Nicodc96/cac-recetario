...
const contenedorModales = [
    ...
    function(){ // 3
        ...
        const img = createElementCustom("img", ["img-top-modal"], "", {
            "width": "500px", 
            "height": "500px",
            "src": "../assets/img-recipes/gramajo_paso4.webp",
            "alt": "revueltogramajo"
        });      
    ...
    function(){ // 4
        ...
        const img = createElementCustom("img", ["img-top-modal"], "", {
            "width": "500px", 
            "height": "500px",
            "src": "../assets/img-recipes/fideoscremachampiñones_pasofinal.webp",
    ...
    function(){ // 5
        ...
        const img = createElementCustom("img", ["img-top-modal"], "", {
            "width": "500px", 
            "height": "500px",
            "src": "../assets/img-recipes/tartabanana_principal.webp",
